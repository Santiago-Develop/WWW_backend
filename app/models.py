...
class AppUserManager(BaseUserManager):
	def create_user(self, email, password=None, phone=None, username=None, documentType=None, documentNumber=None, urlImg=None, role=None, id_country=None, id_department=None, id_city=None, is_staff=None, is_activate=None, is_superuser=None, last_login=None, date_joined=None):
		if not email:
		...
		user.urlImg=urlImg
		user.role=role
		user.id_country=Country.objects.get(id=id_country)
		user.id_department=Department.objects.get(id=id_department)
		user.id_city=City.objects.get(id=id_city)
